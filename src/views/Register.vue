    ...
    <div class="row">
        ...
        <div class="mb-3 col-md-6 col-xs-12">
          <div class="d-flex justify-content-between">
            ...
            <small class="is-invalid" v-if="!$v.password.minLength || !$v.password.required">Mínimo 8 caracteres</small>
          </div>
        ...
        <div class="mb-3 col-md-6 col-xs-12">
          <div class="d-flex justify-content-between">
            <label>Repetir</label>
            <small class="is-invalid" style="text-align: right" v-if="!$v.password.sameAs">Las contraseñas no coinciden</small>
          </div>
  ...
  components: { TextInput },
    ...
    methods: {
        async register() {
          this.$v.$touch();
            if (!this.$v.$invalid) {
              axios.post('/api/users/register', this.user).then(async (resp)=> {
